...
<div class="card mx-2 my-2" style="width: 18rem;">
  <img src="https://t4.ftcdn.net/jpg/05/69/14/77/360_F_569147707_ijFjeSEVRsaIx3xfzAvPteiKrmYvPuM5.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
</div>
  <div class="card-body">
    Welcome Rajsthan State.....
  </div>
</div>
